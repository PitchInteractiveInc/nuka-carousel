...
var Carousel = _react2['default'].createClass({
  ...
  formatChildren: function formatChildren(children) {
    ...
    return _react2['default'].Children.map(children, function (child, index) {
      var className = (0, _classnames2['default'])('slider-slide', { active: index === self.state.currentSlide });
      return _react2['default'].createElement(
        'li',
        { className: className, style: self.getSlideStyles(index, positionValue), key: index },
        child
      );
    });
  },
